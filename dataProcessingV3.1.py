...
filePaths = ["DataDay4/LShapeXYRotTest2_18_03_2025_Data.txt"]
# filePaths = ["DataDay4/LShapeXY1_18_03_2025_Data.txt"]
...
# =============================================================================
    ...
    # dataF = dataF[(dataF.Time > 4)].reset_index()
    dataF = dataF[(dataF.Time > 4) & (dataF.Time < 8)].reset_index()
